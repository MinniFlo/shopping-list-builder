...
func (m model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyPressMsg:
		...
		default:
			...
			m.export.structure = ListEntriesForExport(m.list.collections)
		}
	}
...
func (m model) View() tea.View {
	...
	join_view := lipgloss.JoinHorizontal(0, doc.String(), m.export.View(m.list.GetCurrentPositionID()).Content)
